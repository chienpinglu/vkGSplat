...
one host-owned stage at a time and checks that image error and tile statistics
remain stable. The replacement order should be:
...
some construction stages are still host oracles.
